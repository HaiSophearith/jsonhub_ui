...
export default class CreateControllerComponent extends Component {
  render() {
    return (
      <div>
        <div className=' grid laptop:grid-cols-5 laptop:w-11/12 h-fit laptop:ml-auto laptop:mr-auto laptop:my-10 rounded-lg shadow-[0px_3px_8px_0px_#1A202C]  justify-evenly'>
            <div className=' laptop:border-r-2 border-gray-400 shadow-[0px_0px_8px_0px_#718096] flex flex-col items-center laptop:row-span-4'>
                ...
                <button className=' w-36 bg-blue-500  laptop:mt-4 rounded-lg p-1 font-bold font-poppins text-white'>+ New Controller</button>
            </div>
            <div className=' laptop:col-span-3 laptop:row-span-4 flex flex-col justify-center items-center'>
                      ...
                      <h2 className=' mt-2 font-semibold font-poppins text-2xl'>No Controller or Endpoint</h2>
            </div>
            <div className=' laptop:border-l-2 row-span-3 grid laptop:grid-rows-4 gap-3 border-gray-400 shadow-[0px_0px_6px_0px_#718096]'>
               <div className='  shadow-[0px_6px_6px_0px_#718096] flex flex-col text-center relative pb-6'>
                    <img src={Setting} className=' h-8 w-8 inline-block mt-1 absolute right-2 top-2'/>  
               ...
               <div className='  row-span-3 shadow-[0px_0px_7px_0px_#718096]'>
                  ...
                  <div className=' ml-6 mt-6'>
                    ...
                    <div>
                      ...
                      <div className=' mt-3'>
                      <button className=' text-gray-600 font-semibold' type="submit">See More</button>
