...
export default function FavoriteProject({ FavoriteProject }) {
  return (
    <div>
    ...
    >
      {FavoriteProject
        ? FavoriteProject.info.projectInfo.projectInfo.projectName
        : ""}
    </div>
    <div className="grid grid-cols-3">
      <div className="col-span-2 flex justify-end items-center  laptop:text-[14px] ipad-pro:text-[8px] 12pro:text-[6px]">
        ...
        {/* endpoint number */}
        <span>
          {FavoriteProject ? FavoriteProject.info.projectInfo.urlEndpoint : ""}
        </span>
      </div>
      {/* profile */}
