...
export default function SubnavbarProfile({project, setState, setGrid, disable }) {
  ...
  return (
    <div className="mb-4 bg-white drop-shadow rounded-lg">
      <NavLink className="w-full items-center px-10 py-4 cursor-default uppercase laptop:flex font-black font-poppins laptop:text-base ipad-pro:flex ipad-pro:text-base 12pro:flex 12pro:text-xs border-b-[1px] border-slate-400">
        ...
        <div className="laptop:w-1/2 flex ipad-pro:flex ipad-pro:w-[80%] 12pro:w-full justify-between">
          {/* my project link */}
          <Link className={project === 'myProject'? "bg-purple-head text-white py-1 px-4 rounded-lg" : "py-1 px-4 rounded-lg"}>
            <div onClick={handleMyProject} className="flex items-center">
              <ArticleOutlinedIcon className="mr-1" />
              {
                disable?(
                  <span className="capitalize font-normal text-sm">{username}{"'s projects"}</span>
                ):(
          ...
          {
            disable?(null):(
              <Link to={""} className={project === 'groupProject'? "bg-purple-head text-white py-1 px-4 rounded-lg" : "py-1 px-4 rounded-lg"}>
            <div onClick={handleGroupProject} className="flex items-center">
          ...
          {
            disable?null:(
              <Link to={""} className={project === 'favoriteProject'? "bg-purple-head text-white py-1 px-4 rounded-lg" : "py-1 px-4 rounded-lg"}>
            <div onClick={handleFavoriteProject} className="flex items-center">
