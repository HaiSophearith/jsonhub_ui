...
export default function PutProjectComponent({
  MethodPUT,
  info,
  ControllerName,
  onDelete,
            ...
            catchStore.map((info) =>
              <div className="w-full">
                <ul className="">
                  <button
                    type="button"
                    className="w-full flex justify-between items-center bg-yellow-50 border border-yellow-300 px-4 py-2 transition duration-75 rounded-2xl mb-1 group"
                    onClick={() => dropDownMenu(info.endpointId)}
                  >
                    <div className=" border px-2 border-yellow-300 rounded-lg text-yellow-500 laptop:rounded-md">
                      {/* {MethodPUT.method} */}
                      {info.method}
                    </div>
                    ...
                    <div className=" laptop:flex laptop:flex-row ipad-pro:flex ipad-pro:flex-rpw 12pro:flex 12pro:justify-end ">
                      <div className="flex flex-row">
                        ...
                        <label
                          ...
                          className="hover:scale-110 border border-yellow-300 rounded-lg p-1 hover:cursor-pointer mr-2 text-center w-full flex items-center justify-center">
                          <BorderColorOutlinedIcon className="text-yellow-400" sx={{ fontSize: 20 }} />
                        </label>
                      ...
                      <div className="modal font-montserrat">
                        <div className="modal-box w-[40%] max-w-5xl px-10 py-5 ">
                          ...
                          >
                            Method: <span className="bg-yellow-200 ml-2">{method}</span>
                          </label>

                          <div className="bg-yellow-200 rounded-xl p-4 mt-3">
                          <label
                            for="default-input"
                            ...
                            <div className="modal-action flex justify-center">
                              <div className="flex space-x-6">
                                <label
                                  htmlFor={`my-modal-delete-${info.endpointId}`}
                                  onClick={() => {
                                    handleDeleteEndpoint(info.endpointId, info.httpMethod, "ControllerInvoked");
                                  }}
                  ...
                  <div className="mb-4">
                    <div className="">
                      {dropdown && info.endpointId === selectedEndpointId ? (
                        <div className="bg-yellow-50 rounded-lg p-3 pt-0">
                          <div className=" ipad-pro:w-full 12pro:grid-rows-3 12pro:grid laptop:grid-rows-none ipad-pro:grid ipad-pro:grid-rows-3 laptop:w-full laptop:grid laptop:grid-cols-2 border border-1 border-yellow-400 border-t-0 border-l-0 border-r-0 h-fit py-2 bg-sky-100 ">
            ...
            <ul className="">
              ...
              >
                ...
                <div className=" laptop:flex laptop:flex-row ipad-pro:flex ipad-pro:flex-rpw 12pro:flex 12pro:justify-end ">
                  <div className="flex flex-row">
                    ...
                    <label
                      htmlFor={`my-modal-${endpointId}`}
                      onClick={()=>{EditEndpoint(MethodPUT.endpointId,MethodPUT.method)}}
                      className="hover:scale-110 border border-yellow-300 rounded-lg p-1 hover:cursor-pointer mr-2 text-center w-full flex items-center justify-center">
                        ...
                        <div className="modal-box w-[40%] max-w-5xl px-10 py-5 ">
                          ...
                          <div className="modal-action">
                            <div className="flex space-x-4">
                              ...
                              <label
                                htmlFor={`my-modal-${endpointId}`}
                                onClick={()=>{ModifyEndpoint(MethodPUT.method)}}
                                className="btn btn-primary -mt-3 capitalize font-poppins text-sm rounded-xl w-[120px] h-[30 px]"
                              >
                                Modify
                              </label>
                    ...
                    {/* btn delete */}
                    <label
                      htmlFor={`my-modal-delete-${MethodPUT.endpointId}`}
                      className="hover:scale-110 hover:cursor-pointer border border-red-300 rounded-lg py-1 px-[1.5px] text-center w-full flex items-center"
                    >
                      <DeleteOutlinedIcon className="text-red-400" />
                    </label>
                  ...
                  {/* popUp delete endpoint */}
                    <input
                      type="checkbox"
                      id={`my-modal-delete-${MethodPUT.endpointId}`}
                      className="modal-toggle"
                    />
                        ...
                        <div className="modal-action flex justify-center">
                          <div className="flex space-x-6">
                            <label
                              htmlFor={`my-modal-delete-${MethodPUT.endpointId}`}
                              onClick={() => {
                                handleDeleteEndpointByController(MethodPUT.endpointId, MethodPUT.httpMethod, "MethodInvoked");
                              }}
                              className="btn btn-error text-white capitalize font-poppins text-base rounded-lg px-6 py-1"
                            >
                              DELETE
              ...
              <div className="mb-4">
                <div className="bg-yellow-50 rounded-lg p-3 pt-0">
                  {dropdown ? (
                    MethodPUT === undefined ? (
                      <div className="ipad-pro:w-full 12pro:grid-rows-3 12pro:grid laptop:grid-rows-none ipad-pro:grid ipad-pro:grid-rows-3 laptop:w-full laptop:grid laptop:grid-cols-2 border border-1 rounded-xl h-fit py-2">
                        <div className=" laptop:flex laptop:row-span-1 laptop:col-span-1 laptop:w-full  ipad-pro:flex ipad-pro:row-span-1 ipad-pro:w-full">
                          <div className=" laptop:pl-2 laptop:flex laptop:flex-col ipad-pro:mt-2 ipad-pro:pl-2 ipad-pro:flex-col">
                            <div className="laptop:flex ipad-pro:flex 12pro:flex 12pro:text-[12px] laptop:text-sm ipad-pro:text-xs">
                              <div className="w-[35%] font-bold">ID</div>
                      ...
                      <div className="">
                        <div className="ipad-pro:w-full 12pro:grid-rows-3 12pro:grid laptop:grid-rows-none ipad-pro:grid ipad-pro:grid-rows-3 laptop:w-full laptop:grid laptop:grid-cols-2 border border-1 border-t-0 border-l-0 border-yellow-400 border-r-0 h-fit py-2 bg-sky-100 ">
                          <div className="laptop:flex laptop:row-span-1 laptop:col-span-1 laptop:w-full  ipad-pro:flex ipad-pro:row-span-1 ipad-pro:w-full">
                            <div className="laptop:pl-2 laptop:flex laptop:flex-col ipad-pro:mt-2 ipad-pro:pl-2 ipad-pro:flex-col">
                              <div className="laptop:flex ipad-pro:flex 12pro:flex 12pro:text-[12px] laptop:text-sm ipad-pro:text-xs">
                                <div className="w-[35%] font-bold">ID</div>
                                <div className="">{MethodPUT.endpointId}</div>
                              </div>
                              <div className="laptop:flex 12pro:flex 12pro:text-[12px] ipad-pro:flex laptop:text-sm ipad-pro:text-xs">
                          ...
                          <div className="laptop:w-[100%] laptop:h-[80%] ipad-pro:w-[90%] ipad-pro:h-[80%] 12pro:w-[90%] 12pro:h-[80%] bg-sky-200 12pro:rounded-md laptop:rounded-lg 12pro:py-1 12pro:px-1 laptop:py-0 laptop:px-3 ipad-pro:rounded-lg ipad-pro:py-5 ipad-pro:px-3">
                            <div className="-mt-8">
                              <SyntaxHighlighter
                                ...
                                style={atomDark}
                              >
                                {JSON.stringify(MethodPUT.requestBody, null, 2)}
                              </SyntaxHighlighter>
                            </div>
                          </div>
                        </div>
