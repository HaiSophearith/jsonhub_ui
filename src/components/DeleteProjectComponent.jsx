            ...
            catchStore.map((info) => (
              <div className="w-full">
                <ul className="">
                  <button
                    type="button"
                    className="w-full flex justify-between items-center bg-red-50 border border-red-300 px-4 py-2 transition duration-75 rounded-2xl mb-1 group"
                    onClick={() => dropDownMenu(info.endpointId)}
                  >
                    <div className="border px-2 border-red-300 rounded-lg text-red-500 laptop:rounded-md">
                      {/* {MethodDELETE.method} */}
                      {info.method}
                    </div>
                    <div className="font-montserrat 12pro:text-[12px] text-left laptop:col-span-1 laptop:text-sm ipad-pro:text-xs ">
                      {/* {MethodDELETE.path} */}
                      {info.route}
                    </div>

                    <div className=" 12pro:text-[11px] laptop:text-sm  text-left laptop:col-span-1 ipad-pro:text-sm ">
                      {/* {MethodDELETE.mockIdentify} */}
                      {info.mockIdentify}
                    </div>
                    ...
                    <div className=" laptop:flex laptop:flex-row ipad-pro:flex ipad-pro:flex-rpw 12pro:flex 12pro:justify-end ">
                      ...
                      <div className="modal font-montserrat">
                        <div className="modal-box w-[40%] max-w-5xl px-10 py-5 ">
                          ...
                          >
                            Method: <span className="bg-red-300 ml-2">{method}</span>
                          </label>

                          <div className="bg-red-300 rounded-xl p-4 mt-3">
                          <label
                            for="default-input"
                  ...
                  {/* dropdown toggle */}
                  <div className="mb-4">
                    <div className="bg-red-50 rounded-lg px-3 pt-0">
                      {dropdown && info.endpointId === selectedEndpointId ? (
                        <div>
                          <div className="ipad-pro:w-full 12pro:grid-rows-3 12pro:grid laptop:grid-rows-none ipad-pro:grid ipad-pro:grid-rows-3 laptop:w-full laptop:grid border border-t-0  border-l-0 border-r-0 border-red-400 laptop:grid-cols-2 h-fit py-2 px-3">
          ...
          <div className="w-full">
            <ul className="">
              ...
              >
                ...
                <div className="font-montserrat text-left col-span-1 12pro:text-[12px] laptop:text-sm ipad-pro:text-xs ">
                  {MethodDELETE.route}
                  {/* {info.path} */}
                </div>

                <div className=" 12pro:text-[11px] text-left col-span-1 laptop:text-sm ipad-pro:text-sm ">
                  {MethodDELETE.mockIdentify}
                  {/* {info.mockIdentify} */}
                </div>
                ...
                <div className=" laptop:flex laptop:flex-row ipad-pro:flex ipad-pro:flex-rpw 12pro:flex 12pro:justify-end ">
                  <div className=" flex flex-row">
                    ...
                    <label
                       htmlFor={`my-modal-${endpointId}`}
                       onClick={()=>{EditEndpoint(MethodDELETE.endpointId,MethodDELETE.method)}}
                      className="hover:scale-110 border border-blue-300 rounded-lg p-1 hover:cursor-pointer mr-2 text-center w-full flex items-center justify-center">
                      <BorderColorOutlinedIcon className="text-blue-400" sx={{ fontSize: 20 }} />
                    </label>
                        ...
                        <div className="modal-box w-[40%] max-w-5xl px-10 py-5 ">
                          ...
                          <div className="modal-action">
                            <div className="flex space-x-4">
                              ...
                              <label
                                htmlFor={`my-modal-${endpointId}`}
                                onClick={()=>{ModifyEndpoint(MethodDELETE.method)}}
                                className="btn btn-primary -mt-3 capitalize font-poppins text-sm rounded-xl w-[120px] h-[30 px]"
                              >
                                Modify
                              </label>
                    ...
                    {/* btn delete */}
                    <label
                      htmlFor={`my-modal-delete-${MethodDELETE.endpointId}`}
                      className="hover:scale-110 hover:cursor-pointer border border-red-300 rounded-lg py-1 px-[1.5px] text-center w-full flex items-center"
                    >
                      <DeleteOutlinedIcon className="text-red-400" />
                    </label>
                  ...
                  {/* popUp delete */}
                    <input
                      type="checkbox"
                      id={`my-modal-delete-${MethodDELETE.endpointId}`}
                      className="modal-toggle"
                    />
                    <div className="modal font-montserrat">
                      <div className="modal-box w-[25%] max-w-5xl px-12 py-8 text-center ">
              ...
              <div className="mb-4">
                <div className="bg-red-50 rounded-lg px-3 pt-0">
                  {dropdown ? (
                    MethodDELETE === undefined ? (
                      <div className=" ipad-pro:w-full 12pro:grid-rows-3 12pro:grid laptop:grid-rows-none ipad-pro:grid ipad-pro:grid-rows-3 laptop:w-full laptop:grid laptop:grid-cols-2 border border-1 rounded-lg h-fit py-2 bg-red-100">
                        <div className=" laptop:flex laptop:row-span-1 laptop:col-span-1 laptop:w-full  ipad-pro:flex ipad-pro:row-span-1 ipad-pro:w-full">
                          <div className=" laptop:pl-2 laptop:flex laptop:flex-col ipad-pro:mt-2 ipad-pro:pl-2 ipad-pro:flex-col">
                            <div className="laptop:flex ipad-pro:flex 12pro:flex 12pro:text-[12px] laptop:text-sm ipad-pro:text-xs">
                              <div className="w-[35%] font-bold">ID</div>
                      ...
                      <div className="">
                        <div className="ipad-pro:w-full 12pro:grid-rows-3 12pro:grid laptop:grid-rows-none ipad-pro:grid ipad-pro:grid-rows-3 laptop:w-full laptop:grid laptop:grid-cols-2 border border-1 border-t-0 border-l-0 border-r-0 border-red-400 h-fit py-2 bg-sky-100 ">
                          <div className="laptop:flex laptop:row-span-1 laptop:col-span-1 laptop:w-full  ipad-pro:flex ipad-pro:row-span-1 ipad-pro:w-full">
                            <div className="laptop:pl-2 laptop:flex laptop:flex-col ipad-pro:mt-2 ipad-pro:pl-2 ipad-pro:flex-col">
                              <div className="laptop:flex ipad-pro:flex 12pro:flex 12pro:text-[12px] laptop:text-sm ipad-pro:text-xs">
                                <div className="w-[35%] font-bold">ID</div>
